...
function SortProduct() {
    return (
        <div className="w-full lg:w-[30%]  flex justify-end items-center gap-4 text-header">
            ...
            <select id="sort-by" className=" w-full bg-white border-2 capitalize border-secondary  text-lg rounded-lg focus:ring-header focus:border-header outline-header  block p-2 ">
