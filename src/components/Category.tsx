...
function Category() {
    ...
    return (
        <div className="p-4 border-b-2">
            ...
            <select id="category" className=" bg-white border-2 capitalize border-secondary  text-xl rounded-lg focus:ring-header focus:border-header block w-full p-2.5 ">
                <option  className="text-xl p-4 border-b-2 hover:bg-secondary cursor-pointer" value={"s"}>--All Product--</option>
